...
from gestion_pedidos import registrar_pedido, cambiarEstadoPedido, agregarPresupuestoPedido
...
opciones = [
    {
        ...
        "choices": ["Registrar nuevo pedido", "Ver Todos Los Pedidos","Ver Pedidos Filtrados","Asignar Pedido","Cambiar estado de pedido","Agregar presupuesto", "Gestionar Stock", "Salir"],
    },
]
